...
Background:
    Given the following products
        ...
        | Apple iPhone 13 | Smart Phones| True      | Used Apple iPhone 13  | 100     | https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-13-pink-select-2021?wid=940&hei=1112&fmt=png-alpha&.v=1645572315935 |
        | Fujifilm Camera | Cameras     | True      | Used 1986 Fuji Camera | 85      | https://i.ebayimg.com/images/g/y1sAAOSwHvhmBVoA/s-l1600.webp |
