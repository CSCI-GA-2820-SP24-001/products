# NYU DevOps Product Team ReadMe SD
...
Remember what Kevin Garnett said about DevOps... With DevOps...

![Dab](https://media.tenor.com/Xf3qXFZc6OgAAAAM/champion-winner.gif)

## Overview

This Readme file is meant to walk you through our application. So far we have created a database model, as well as the ability to create, read, update, and delete products. See our model and rest APIs at  `/service` -`models.py` a `routes.py` file for your service.
...
├── models.py              - module with product models
├── routes.py              - module with service routes for products
